...
We are happy to accept your patches! This document explains what you have to do to contribute to Surf's code.
...
Surf project is made available under the terms of LGPL.
...
4. To check that your environment is functional, build Surf by following these instruction:
    * build Surf by running this command in the folder where the project resides: `mvn clean install`.
